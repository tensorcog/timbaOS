            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <button
                  ...
                  className="group relative overflow-hidden rounded-xl border bg-gradient-to-br from-amber-600/10 via-purple-500/5 to-transparent p-6 backdrop-blur hover:from-amber-600/20 hover:via-purple-500/10 transition-all text-left"
                >
                  <div>
