            ...
            {step === "select" && (
                <div className="grid gap-4 md:grid-cols-3">
                    ...
                    <button
                        ...
                        className="group text-left relative overflow-hidden rounded-xl border bg-gradient-to-br from-amber-600/10 via-purple-500/5 to-transparent p-6 backdrop-blur hover:from-amber-600/20 hover:via-purple-500/10 transition-all"
                    >
